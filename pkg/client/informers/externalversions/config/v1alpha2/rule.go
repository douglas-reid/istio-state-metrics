...
import (
	...
	config_v1alpha2 "github.com/douglas-reid/istio-state-metrics/pkg/apis/config/v1alpha2"
	...
	v1alpha2 "github.com/douglas-reid/istio-state-metrics/pkg/client/listers/config/v1alpha2"
...
func (f *ruleInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&config_v1alpha2.Rule{}, f.defaultInformer)
}
